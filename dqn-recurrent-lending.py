...
def main():
    ...
    prs.add_argument("-lr", dest="lr", type=float, default=0.005, required=False, help="learning rate.\n")
    ...
    prs.add_argument("-bs", dest="batch_size", type=int, default=512, required=False,
                     help="Batch Size\n")
...
def save_plot_avg(reward_list_all, args, curr, num_exps, num_people, max_ep_len):
    ...
    plt.savefig("./lending/rewardDQN" + args.state_mode + "-cf" + str(args.counterfactual) + "-" + current_time + ".png")
    plt.show()

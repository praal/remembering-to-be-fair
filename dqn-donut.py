...
class DQN():
    ...
    def counterfactual_update(self, fair_env, state, action, prev_reward, next_state, actual_memory, max_ep_len, state_mode = 'binary', num_updates=2):
        all_possible = []
...
def save_plot_avg(reward_list_all, donuts_list_all, args, num_exps, num_people, max_ep_len):
    ...
    plt.savefig("./donut/DQN" + args.state_mode + "-cf" + str(args.counterfactual) + "-" + current_time + ".png")
    plt.show()
